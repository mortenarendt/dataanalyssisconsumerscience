...
Trouble shooting: \* Try new csv format in Excel whan saving the file in csv format \* Try to write read.csv(file.choose()) instead \* Try another import function (see below)
