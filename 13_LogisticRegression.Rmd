...
#Bedre/nemnmere end at lave to modeller? Bare at droppe den ene af dem? Det giver i hvert fald samme resultat...
drop1(logreg.1.cntr_1, test = "Chisq")

#Eller er det bedre for forståelsen, at man laver begge?
...
Here we use the clusters from the consumer segmentation analysis as provided in [Segmentation - example 2]
