...
From this, _Interest in food_ sis the least significant one, and is hence removed. 
...
It could be  ice to calculate if the liking of specific sample are affected by the degree of future interest in beer. This can be visualized as scatterplots and modelled using interactions.
