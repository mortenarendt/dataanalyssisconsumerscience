...
table(Surveylong$answ,Surveylong$question) # across question
```
...
Surveylong_buffet %>% 
  ...
  mutate(question2 = question %>% substr(1,34)) %>% # The label is too long, so lets just represent the first 30 letters.
