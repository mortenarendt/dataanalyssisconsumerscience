...
In this book several datasets are used targeting different reesearch questions. 
However, a fair part of the analysis tools are common. That is, deescriptive analysis, plots, response correlations etc. 
